...
echo "		▄▀▀▀█▄ ▄█▀▄ ██ ▄▄▐█·▄█▀▀█ ██▪      ▐█▀▀█▄ ▄█▀▄  ·██· "
echo "		▐█▄▪▐█▐█▌.▐▌▐███▌▐█▌▐█ ▪▐▌▐█▌▐▌    ██▄▪▐█▐█▌.▐▌▪▐█·█▌"
echo -e "		 ▀▀▀▀  ▀█▄▀▪·▀▀▀ ▀▀▀ ▀  ▀ .▀▀▀     ·▀▀▀▀  ▀█▄▀▪•▀▀ ▀▀$nc $blue DZ$nc"
echo -e "	[+]               $red Coded By Adam Seliany        		   [+]"
echo -e "	[+] 		 $red   www.facebook.com/adem.seliani23/ 		       [+]"
echo -e "	[+] 		 $red           ALGERIAN TEAMS               		   [+]"
echo -e "	[+]$red Special Greetz To$nc :$green {thelinuxchoice , Algerianteams}$nc [+]"
echo ""
